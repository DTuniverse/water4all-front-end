    ...
    return(
        <div>
            <div>
                ...
                src={process.env.PUBLIC_URL + "/resources/handInWater.svg"} 
                alt="a hand touching the water surface"/>
            </div>
            ...
            <div class="articleTextContainer">
                ...
                Clean drinking water is not just a basic necessity, it is a fundamental human right.<br /> Ensuring the 
                protection and availability of clean water for all individuals is essential for promoting health, 
                preserving ecosystems, and fostering societal well-being. <br />In this article, we will explore why 
                ...
                Access to clean drinking water is crucial for safeguarding public health and well-being. <br />Contaminated 
                water sources can lead to the spread of waterborne diseases, causing severe illness and even death. 
                <br />By acknowledging clean water as a human right, governments and societies are compelled to prioritize 
                ...
                management of water resources. <br />Water is a finite and precious resource, intricately connected to 
                ecosystems and biodiversity. <br />By protecting clean water sources, we can preserve delicate aquatic 
                ...
                in society. <br />Marginalized communities, including those in poverty, remote areas, or conflict zones, 
                often face significant challenges in accessing clean water. <br />By enshrining the right to clean drinking
                ...
                participate in decision-making processes regarding water management. <br />It encourages community engagement, 
                promoting inclusive dialogue, and fostering partnerships between governments, civil society, and stakeholders. 
                <br />Such participation allows for the development of sustainable water management strategies that meet the 
                ...
                particularly Goal 6:<br /> Clean Water and Sanitation. Protecting this right contributes to achieving not only SDG 6 but 
                also other interconnected goals, such as eradicating poverty, improving health and well-being, ensuring gender 
                equality, and fostering sustainable cities and communities. <br />Water is a linchpin for sustainable development, and its 
                ...
                <br />This recognition promotes intergenerational equity, encouraging sustainable practices that conserve water 
                ...
                towards building a <br />just and sustainable world. Protecting this right upholds public health, preserves ecosystems, 
                addresses inequality, and empowers communities. <br />By acknowledging clean water as a fundamental human right, we take 
