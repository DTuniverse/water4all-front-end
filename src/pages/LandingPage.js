    ...
    <div>
      ...
      <div className="missionParentContainer">
        <div className="missionH1Container">
          <h1 className="missionH1" style={{ textAlign: "left" }}>
            OUR MISSION
          </h1>
        </div>
        <div className="missionPContainer">
          <p className="missionP">
            Our mission is to ensure easy access to clean drinking water for
            everyone. Through our interactive map, we provide locations
            <br />
            of drinking fountains, restaurants, cafés
            <br />
            and other places where people can find
            <br />
            free drinking water. YOU can contribute
            <br />
      ...
      <div>
        <img
          className="howImage"
          src={process.env.PUBLIC_URL + "/resources/HowWeDoItNew.svg"}
