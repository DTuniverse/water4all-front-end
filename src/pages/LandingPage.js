  ...
  return (
    <div>
      ...
      <div>
        <img
          className="heroImage"
          src={process.env.PUBLIC_URL + "/resources/Group 20 (1).svg"}
      ...
      <div className="ourMission">
        ...
        <div className="missionPContainer">
          <span className="missionP">
            Our mission is to ensure easy access to clean
          </span>
          <span className="missionP">
            drinking water for everyone. Through our
          </span>
          <span className="missionP">
            interactive map, we provide locations of
          </span>
          <span className="missionP">
            drinking fountains, restaurants, cafés, and
          </span>
          <span className="missionP">
      ...
      <div>
        <img
          ...
          src={process.env.PUBLIC_URL + "/resources/Group 22@1x.svg"}
      ...
      <div>
        <img
          className="howImage"
          src={process.env.PUBLIC_URL + "/resources/Group 19.svg"}
